#' print.summary.hdlmm
#'
#' @param object an object of type 'summary.hdlmm', result of call to summary.hdlmm()
...
#' @export
#'
print.summary.hdlmm <- function(object, digits = 4, cw.only = TRUE)
{
  cat("\nHDLMM:\n\n")
  ...
  cat("-", object$mixPrior, "exposure sparsity prior\n")
