...
#' Determine split points for continuous modifiers
#'
...
#' @param round The number of decimal places to round the variable (var) to. No rounding occurs if round=NULL (default). For positive integer values of round, the variable will be rounded and split points will be reported at the resulting level.
#'
